...
- Main takeaways: Choose high powered offenses and teams that played tough schedules to win, stay away from very low seeds. There is no 'secret metric' such as bench depth, height, or luck that highly deterministic to wins. 
...
*Each panel shows one underdog type. Green bars (left) indicate areas where the underdog is closer to the favorite — a relative strength. Orange bars (right) indicate where the gap is largest — a weakness. Clusters are sorted by upset rate.*
